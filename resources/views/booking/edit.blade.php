    ...
    <div class="w-full max-w-[1280px] mx-auto px-4 sm:px-6 py-8">
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-6">
                ...
                <div class="flex flex-col">
                    <h1 class="text-[#111418] dark:text-white text-2xl font-bold leading-tight">
                        แก้ไขรายการจอง #{{ $booking->id }}
                    </h1>
                    <span class="text-sm text-gray-500 dark:text-gray-400">Edit Booking</span>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-[#1a2632] rounded-xl border border-[#dce0e5] dark:border-gray-800 shadow-sm p-6 sm:p-8">
                ...
                <form method="POST" action="{{ url('/booking/' . $booking->id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
                    {{ method_field('PATCH') }}
                    {{ csrf_field() }}

                    @include ('booking.form', ['formMode' => 'edit'])
