            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/semesters') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>Date Start</th><th>Date End</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($semesters as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td><td>{{ $item->date_start }}</td><td>{{ $item->date_end }}</td>
                                        <td>
                            ...
                            <div class="pagination-wrapper"> {!! $semesters->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
